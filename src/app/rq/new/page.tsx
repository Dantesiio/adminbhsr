          ...
          <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              ...
              <div>
                ...
                <input type="text" className={inputCls} placeholder="Ej. ECHO" {...form.register('financiador')} />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  step="0.01"
                  className={inputCls}
                  placeholder="Ej. 4219.38"
                  {...form.register('euroRate', { valueAsNumber: true })}
                />
              </div>
              ...
              <div>
                ...
                <input
                  type="date"
                  className={inputCls}
                  {...form.register('fechaEntregaDeseada')}
                />
              </div>
              ...
              <div className="sm:col-span-2">
                ...
                <input
                  type="text"
                  className={inputCls}
                  placeholder="Ej. 3A Norte # 24N78, Cali"
