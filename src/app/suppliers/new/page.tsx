...
export default function NewSupplierPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!res.ok) { setError(data.error || 'Error al crear proveedor'); return }
      ...
      <div className="mx-auto max-w-2xl space-y-6">
        ...
        <div className="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
          <div className="border-b border-gray-100 px-6 py-5">
            ...
            <p className="mt-1 text-sm text-gray-500">Registra un proveedor para poder asociarlo a cotizaciones y órdenes de compra.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 p-6">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
              />
              <p className="text-xs text-gray-400">Debe ser único en el sistema.</p>
            </div>
