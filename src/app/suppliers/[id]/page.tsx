...
export default async function SupplierDetailPage({ params }: { params: { id: string } }) {
  ...
  const volumenTotal = supplier.pos.reduce((sum: number, po: { total: number | string }) => sum + Number(po.total), 0)
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-50">
                ...
                <tbody className="divide-y divide-gray-50 bg-white">
                  {supplier.quotes.map((quote: { id: string; total: number | string; createdAt: string | Date; rq: { id: string; code: string; title: string; status: string } }) => (
          ...
          <div className="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-50">
                ...
                <tbody className="divide-y divide-gray-50 bg-white">
                  {supplier.pos.map((po: { id: string; number: string; total: number | string; createdAt: string | Date }) => (
