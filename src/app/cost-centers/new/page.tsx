...
export default function NewCostCenterPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!res.ok) { setError(data.error || 'Error al crear centro de costo'); return }
      ...
      <div className="mx-auto max-w-2xl space-y-6">
        ...
        <div className="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
          <div className="border-b border-gray-100 px-6 py-5">
            <h1 className="text-lg font-semibold text-gray-900">Nuevo centro de costo</h1>
            <p className="mt-1 text-sm text-gray-500">
              Los centros de costo identifican el área o departamento que absorbe el gasto de cada requisición.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 p-6">
            ...
            <div className="flex items-center justify-end gap-3 pt-2">
              ...
              >
                ...
                {saving ? 'Guardando…' : 'Crear centro de costo'}
              </button>
            </div>
          </form>
        </div>
