    ...
    <Layout>
      <div className="min-h-[70vh] bg-slate-100">
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-12 px-4 py-16 sm:px-6 lg:px-8">
          ...
          <section className="rounded-3xl bg-white/90 p-8 shadow-lg backdrop-blur">
            <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
              ...
              <form onSubmit={handleSearch} className="w-full sm:w-auto">
                <div className="flex w-full flex-col gap-3 sm:flex-row sm:items-center">
                  ...
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center rounded-xl bg-blue-600 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-blue-600/30 transition hover:-translate-y-0.5 hover:bg-blue-700"
                  >
                    Buscar
                  </button>
                </div>
          ...
          <footer className="rounded-3xl border border-dashed border-slate-300 bg-white/80 p-8 text-center text-sm text-slate-500">
