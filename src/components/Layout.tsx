...
const NAV_ITEMS: NavItem[] = [
  { href: '/dashboard', label: 'Dashboard', icon: IconDashboard, roles: ['SOLICITANTE', 'COMPRAS', 'AUTORIZADOR', 'ADMIN'] },
  { href: '/rq/new', label: 'Nueva RQ', icon: IconPlus, roles: ['SOLICITANTE', 'ADMIN'] },
  { href: '/rq', label: 'Requisiciones', icon: IconClipboard, roles: ['SOLICITANTE', 'COMPRAS', 'AUTORIZADOR', 'ADMIN'] },
